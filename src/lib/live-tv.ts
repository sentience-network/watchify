...
const CHANNELS_BASE: LiveChannel[] = [
  ...
  },
  {
    ...
    year: new Date().getFullYear(),
    overview:
      "France 24 English — free international news livestream via the official YouTube Live channel.",
    posterPath: ytThumb("Ap-UM1O9RBU"),
    backdropPath: ytThumb("Ap-UM1O9RBU"),
    genres: ["News", "Live"],
    runtime: 0,
    rating: 0,
    youtubePlaybackId: "Ap-UM1O9RBU",
    licenseKind: "public_broadcast",
    isLive: true,
    liveCategory: "news",
    mediaType: "tv",
    attribution: {
      ...
      sourceUrl: "https://www.youtube.com/watch?v=Ap-UM1O9RBU",
    },
  },
  {
