# Watchify investor demo script

**Live:** https://watchify-web-9rx1.onrender.com  
**Honest framing (say early):** Watchify is a social watch-party + taste app. Friends sync playheads and presence while each person watches on their own streaming apps. We do **not** stream licensed Netflix/Max/Disney+ inside Watchify.

**Local polished capture (gitignored `demos/`):**  
`demos/watch-party-rich-2026-07-19T23-06-41/watchify-party-full-demo.mp4` — rich party walkthrough (Discover → party → free sync playback → chat → WebRTC). Re-record with `node scripts/record-watch-party-demo.mjs` if needed.

---

## A. 60–90 second investor walkthrough
...
## B. Optional 3-minute deep dive

1. **Landing clarity** (20s) — Brand-first hero; kill “in-app Netflix” misconception.  
...
9. **Ask** (15s) — Soft launch traction hooks (live product, TURN for video rooms, Party trial funnel) + ask placeholder.

---

## C. What not to say

- Don’t imply Watchify plays Netflix/Max/Disney+ video in-browser.  
- Don’t imply password sharing or screen-sharing paid apps.  
- Don’t treat TMDB posters as proof of licensed library.  
- Do say: own accounts, playhead sync, Watchify Free = real sync, Party trial.

---

## D. Capture notes for screenshots / video

See [SCREENSHOT_CHECKLIST.md](./SCREENSHOT_CHECKLIST.md). Prefer a Free title (e.g. Big Buck Bunny) for in-party sync demos. Wake Render (~30–60s) before recording.
