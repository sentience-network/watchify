  ...
  return (
    <div className="relative">
      <input
        ...
        spellCheck={false}
        className="auth-field w-full rounded-xl border border-line bg-ink/80 px-4 py-3 pr-16 text-sm text-white caret-white outline-none focus:ring-2 focus:ring-teal/40"
        style={{
          color: "#eef5f1",
